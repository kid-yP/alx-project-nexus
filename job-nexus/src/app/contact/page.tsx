              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className={`form-item ${isVisible.form ? 'visible' : ''}`}>
                  <button
                    ...
                    className="w-full bg-white text-blue-600 py-4 rounded-lg font-medium hover:bg-blue-50 disabled:bg-gray-300 disabled:cursor-not-allowed transition text-xl flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
